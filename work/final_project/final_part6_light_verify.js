...
function setup_stuff()
{
	...
	let light_pos = vec4(-21.5 /*right of cam*/,52.1 /*above*/,	-1.7 /*behind*/,0.0); // a bit above, to the right and in the front of the camera
	...
	gl.useProgram(program);
	sphere = sphere_3d(3);
	gl.uniform1i(uniforms.is_sphere,true);
	trsMatrix=translate(1.0,.3,4.0 );
	...
	send_floats_to_attribute_buffer("a_Position", flatten(sphere.Points), 4, gl, program);
	gl.drawArrays(gl.TRIANGLES, 0, sphere.drawCount);

	gl.uniform1i(uniforms.is_sphere,false);	
